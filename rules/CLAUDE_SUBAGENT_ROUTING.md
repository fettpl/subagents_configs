# Claude Code Subagent Routing Policy
...
instructions. Read-only roles must use only Read, Grep, and Glob in plan mode;
their tool and permission restrictions are technical enforcement, not prose.
